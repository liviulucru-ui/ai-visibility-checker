    ...
    <ContentPage eyebrow="Pricing" title="Simple, one-time pricing." intro="No subscriptions. No recurring fees. Get a complete, prioritized action plan for your business visibility.">
      ...
      <div className="mt-24">
        ...
        <FAQList items={[
          ...
          ['What is in the full report?', 'The full report expands the analysis to 20–30 queries, provides a detailed breakdown of the exact technical and content gaps giving your competitors an edge, and generates a prioritized Priority Action Plan to improve your visibility.'],
          ...
          ['Do I need technical skills to implement the recommendations?', 'No. The Priority Action Plan prioritizes changes based on effort and impact. Most recommendations involve updating your website copy, adding schema markup, or claiming business profiles.'],
